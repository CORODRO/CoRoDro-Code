...
rospy.init_node('pose_to_odom2')

vicon_sub = rospy.Subscriber('/vrpn_client_node/Quadri_MK_4/pose', PoseStamped, vicon_cb, queue_size=100)
odom_pub = rospy.Publisher('/camera/odom/sample', Odometry, queue_size=100)
...
while not rospy.is_shutdown():
    ...
    if counter > 0:
        ...
        br.sendTransform((x,y,z),[pose.pose.orientation.x, pose.pose.orientation.y,pose.pose.orientation.z,pose.pose.orientation.w],rospy.Time.now(), "camera_link","camera_odom_frame")
