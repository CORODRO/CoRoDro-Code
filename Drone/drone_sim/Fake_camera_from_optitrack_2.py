...
vicon_sub = rospy.Subscriber('/vrpn_client_node/bebop_08/pose', PoseStamped, vicon_cb, queue_size=100)
...
while not rospy.is_shutdown():
    ...
    if counter > 0:
        ...
        br.sendTransform((x,y,z),[pose.pose.orientation.x, pose.pose.orientation.y,pose.pose.orientation.z,pose.pose.orientation.w],rospy.Time.now(), "base_link_frd","odom_ned")
